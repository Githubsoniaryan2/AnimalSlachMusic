...
from BRANDEDKING.utils.decorators.admins import ActualAdminCB
from BRANDEDKING.utils.decorators.language import language, languageCB
from BRANDEDKING.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from BRANDEDKING.utils.inline.start import private_panel
